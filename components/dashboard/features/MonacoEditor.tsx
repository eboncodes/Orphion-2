...
export default function MonacoEditor({
  ...
  const handleEditorWillMount = (monaco: any) => {
    // Define a custom light theme with softer colors
    monaco.editor.defineTheme('custom-light', {
      ...
      rules: [
        ...
        { token: 'number', foreground: 'FF9999' },
        { token: 'predefined', foreground: 'CCCCCC' },
  ...
  return (
    <div className="relative border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm transition-shadow duration-200">
