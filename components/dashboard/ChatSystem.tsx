...
import { Paperclip, Mic, ArrowUp, Sliders, Copy, ThumbsUp, ThumbsDown, Volume2, Pencil, Share2, RotateCcw } from "lucide-react"
              ...
              <div className="max-w-[70%]">
                <div className="bg-transparent rounded-2xl px-4 py-3">
                  <div className="flex items-center space-x-2">
                    <Spinner size="md" className="border-gray-600" />
                    <span className="text-sm text-gray-600">OrphionAI is thinking...</span>
                  </div>
                </div>
              </div>
            </div>
